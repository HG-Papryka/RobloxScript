-- =============================================
-- PART 1: LOBBY - creates private server & teleports
-- =============================================
...
-- button loop - handles every round automatically
task.spawn(function()
    while true do
